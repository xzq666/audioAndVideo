...
#define ControllerBacViewColor ([ZXTheme defaultTheme].zx_isDarkTheme ? ZXThemeDarkLevel1Color : [UIColor whiteColor])
        ...
        tableViewTheme.cellForRowAtIndexPath = ^UITableViewCell * _Nonnull(UITableViewCell * _Nonnull cell, NSIndexPath * _Nonnull indexPath) {
            ...
            for (UIView *view in cell.contentView.subviews) {
                ...
                if([view isKindOfClass:[UIImageView class]]){
                    ((UIImageView *)view).image = [((UIImageView *)view).image renderColor:TableViewCellImageViewRenderColor];
                }
            }
            return cell;
        };
